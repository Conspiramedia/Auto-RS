...
class PushService {
  ...
  // ----------------------------------------------------------
  // Выдано ли разрешение на уведомления прямо сейчас.
  //
  // Нужна перед показом объясняющего листа: если человек уже разрешил
  // уведомления (например, в системных настройках), объяснять ему смысл
  // пушей и спрашивать повторно — лишний шаг.
  //
  // При ошибке возвращаем false: лучше показать лист лишний раз, чем
  // молча оставить пользователя без уведомлений.
  // ----------------------------------------------------------
