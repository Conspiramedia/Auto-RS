...
// Красивый вид номера для ПОКАЗА: из любого хранимого формата (E.164
// «+381600000000», «381600000000», «0600000000») делает «+381 60 000 0000»
// (группы национальной части 2-3-3(+1)). Если номер не сербский — возвращаем
// исходную строку как есть (лучше показать, чем скрыть).
String serbianPhoneDisplay(String raw) {
  final d = serbianNationalDigits(raw);
